...
[Serializable]
public struct CharPredictedStateData : IComponentData, INetPredicted<CharPredictedStateData>
{
...
//        GameDebug.Log("SetAction:" + action + " tick:" + tick);
    ...
    {
        return locoState == CharPredictedStateData.LocoState.Stand || locoState == CharPredictedStateData.LocoState.GroundMove;
    }

#if UNITY_EDITOR
    public bool VerifyPrediction(ref CharPredictedStateData state)
    {
...
public class CharPredictedStateComponent : ComponentDataWrapper<CharPredictedStateData>
{}