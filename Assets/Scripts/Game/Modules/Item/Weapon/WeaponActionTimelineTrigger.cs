...
public class WeaponActionTimelineTrigger : MonoBehaviour  
{
    [Serializable]
...
// System
[DisableAutoCreation]
public class UpdateWeaponActionTimelineTrigger : BaseComponentSystem<CharPresentation, WeaponActionTimelineTrigger>
{
    public UpdateWeaponActionTimelineTrigger(GameWorld world) : base(world) {}
    
    protected override void Update(Entity entity, CharPresentation charPresentation, WeaponActionTimelineTrigger behavior)
    {
    ...
    public static void Update(WeaponActionTimelineTrigger behavior, PresentationState animState)
    {
