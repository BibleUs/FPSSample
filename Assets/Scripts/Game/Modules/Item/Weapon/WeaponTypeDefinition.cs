...
[CreateAssetMenu(fileName = "WeaponTypeDefinition", menuName = "FPS Sample/Weapon/WeaponTypeDefinition")]
public class WeaponTypeDefinition : ReplicatedEntityFactory
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(WeaponTypeDefinition))]
public class WeaponTypeDefinitionEditor : ReplicatedFactoryEntryEditor<WeaponTypeDefinition>
{
...
[DisableAutoCreation]
public class HandleWeaponSpawn : InitializeComponentDataSystem<WeaponTypeDefinition.State, HandleWeaponSpawn.Initialized>
{
    public struct Initialized : IComponentData{}
    
    public HandleWeaponSpawn(GameWorld gameWorld) : base(gameWorld)
    {}

    protected override void Initialize(Entity entity, WeaponTypeDefinition.State component)
    {
