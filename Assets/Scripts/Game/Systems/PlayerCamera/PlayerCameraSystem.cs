...
public class UpdatePlayerCameras : BaseComponentSystem {
    ...
    protected override void OnUpdate() {
        ...
        for (var i = 0; i < cameraArray.Length; i++) {
            ...
            if (debugCameraDetach.IntValue == 2 && !Console.IsOpen()) {
                ...
                eu += Time.deltaTime *
                      (new Vector3(-invertY * Input.GetAxisRaw("RightStickY") * InputSystem.s_JoystickLookSensitivity.y,
                ...
                camera.transform.Translate(
                    new Vector3(Input.GetAxisRaw("Horizontal"), verticalMove, Input.GetAxisRaw("Vertical")) *
                    Time.deltaTime * m_DetachedMoveSpeed);
            }
    ...
    [ConfigVar(Name = "debug.cameramove", Description = "Show graphs of first person camera rotation",
        DefaultValue = "0")]
